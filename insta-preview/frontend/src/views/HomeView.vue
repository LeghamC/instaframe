      ...
      <Transition name="fade">
        <div v-if="showCreate" class="modal-backdrop" @click.self="showCreate = false">
          <div class="modal">
            ...
            <div class="form-group">
              <label>Bio</label>
              <textarea class="input" v-model="form.bio" rows="3" placeholder="📸 Photographer · Paris"
            ...
            <div class="modal-actions">
              <button class="btn btn-ghost" @click="showCreate = false" :disabled="creating">Cancel</button>
              <button class="btn btn-primary" @click="createSession" :disabled="!form.name || creating">
...
async function createSession() {
  ...
  try {
    ...
    createError.value = 'Could not connect to the backend. Make sure it is running on port 3001.'
...
.create-error {
  ...
  border: 1px solid rgba(247, 122, 122, 0.3);
  color: var(--red);
  border-radius: var(--radius-sm);
  padding: 10px 14px;
  font-size: 13px;
